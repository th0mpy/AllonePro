...
// INPUT DATA
/*
// Crys_freq(Hz): 30000000    Crys_tol(ppm): 10    IF_mode: 2    High_perf_Ch_Fil: 1    OSRtune: 0    Ch_Fil_Bw_AFC: 0
ANT_DIV: 0    PM_pattern: 0
// MOD_type: 3    Rsymb(sps): 12800    Fdev(Hz): 25000    RXBW(Hz): 150000    Manchester: 0    AFC_en: 0    Rsymb_error:
0.0    Chip-Version: 2
// RF Freq.(MHz): 434.09547    API_TC: 29    fhst: 0    inputBW: 0    BERT: 0    RAW_dout: 0    D_source: 0 Hi_pfm_div:
1
...
*/
#define RF_GPIO_PIN_CFG 0x13, 0x00, 0x00, 0x21, 0x20, 39, 0x00, 0x00
...
*/
#define RF_GLOBAL_XO_TUNE_2 0x11, 0x00, 0x02, 0x00, 0x62, 0x00
...
//   PREAMBLE_CONFIG_STD_2 - Configuration of timeout periods during reception of a packet with Standard Preamble
pattern.
...
*/
#define RF_PREAMBLE_TX_LENGTH_9 0x11, 0x10, 0x09, 0x00, 0x05, 0x0A, 0x00, 0x0F, 0x31, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_SYNC_CONFIG_6 0x11, 0x11, 0x06, 0x00, 0x31, 0xB4, 0x2B, 0x00, 0x00, 0x00
...
//   PKT_WHT_BIT_NUM - Selects which bit of the LFSR (used to generate the PN / data whitening sequence) is used as the
output bit for data scrambling.
...
//   PKT_LEN_ADJUST - Provides for adjustment/offset of the received packet length value (in order to accommodate a
variety of methods of defining total packet length).
//   PKT_TX_THRESHOLD - TX FIFO almost empty threshold.
*/
#define RF_PKT_CRC_CONFIG_12 \
  0x11, 0x12, 0x0C, 0x00, 0x04, 0x01, 0x08, 0xFF, 0xFF, 0x20, 0x12, 0x00, 0x2A, 0x01, 0x00, 0x30
...
#define RF_PKT_RX_THRESHOLD_12 \
  0x11, 0x12, 0x0C, 0x0C, 0x30, 0x00, 0x01, 0x00, 0x82, 0x00, 0x07, 0x00, 0x2A, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_FIELD_3_CRC_CONFIG_12 \
  0x11, 0x12, 0x0C, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
*/
#define RF_PKT_RX_FIELD_1_CRC_CONFIG_12 \
  0x11, 0x12, 0x0C, 0x24, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00
...
#define RF_MODEM_MOD_TYPE_12 \
  0x11, 0x20, 0x0C, 0x00, 0x03, 0x00, 0x07, 0x07, 0xD0, 0x00, 0x05, 0xC9, 0xC3, 0x80, 0x00, 0x06
...
*/
#define RF_MODEM_TX_RAMP_DELAY_12 \
  0x11, 0x20, 0x0C, 0x18, 0x01, 0x80, 0x08, 0x03, 0x80, 0x00, 0x20, 0x10, 0x00, 0xE8, 0x00, 0xC3
...
AFC functionality.
*/
#define RF_MODEM_BCR_NCO_OFFSET_2_12 \
  0x11, 0x20, 0x0C, 0x24, 0x02, 0x9F, 0x17, 0x01, 0x50, 0x02, 0xC2, 0x00, 0x04, 0x23, 0x80, 0x25
...
*/
#define RF_MODEM_AFC_LIMITER_1_3 0x11, 0x20, 0x03, 0x30, 0x0B, 0x9A, 0x80
...
#define RF_MODEM_AGC_WINDOW_SIZE_12 \
  0x11, 0x20, 0x0C, 0x38, 0x11, 0x2B, 0x2B, 0x80, 0x1A, 0xFA, 0x00, 0x00, 0x29, 0x0C, 0xA4, 0x22
...
*/
#define RF_MODEM_RAW_CONTROL_10 0x11, 0x20, 0x0A, 0x45, 0x83, 0x01, 0x9F, 0x01, 0x00, 0xFF, 0x06, 0x00, 0x18, 0x40
...
*/
#define RF_MODEM_SPIKE_DET_2 0x11, 0x20, 0x02, 0x54, 0x05, 0x07
...
//   MODEM_DSA_QUAL - Configures parameters for the Eye Opening qualification m ethod of the Signal Arrival Detection
algorithm.
//   MODEM_DSA_RSSI - Signal Arrival Detect RSSI Qualifier Config
//   MODEM_DSA_MISC - Miscellaneous detection of signal arrival bits.
*/
#define RF_MODEM_DSA_CTRL1_5 0x11, 0x20, 0x05, 0x5B, 0x40, 0x04, 0x0C, 0x78, 0x20
...
// Default values:           0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
// Descriptions:
//   MATCH_VALUE_1 - Match value to be compared with the result of logically AND-ing (bit-wise) the Mask 1 value with
the received Match 1 byte.
...
//   MATCH_VALUE_2 - Match value to be compared with the result of logically AND-ing (bit-wise) the Mask 2 value with
the received Match 2 byte.
//   MATCH_MASK_2 - Mask value to be logically AND-ed (bit-wise) with the Match 2 byte.
//   MATCH_CTRL_2 - Configuration of Match Byte 2.
//   MATCH_VALUE_3 - Match value to be compared with the result of logically AND-ing (bit-wise) the Mask 3 value with
the received Match 3 byte.
//   MATCH_MASK_3 - Mask value to be logically AND-ed (bit-wise) with the Match 3 byte.
//   MATCH_CTRL_3 - Configuration of Match Byte 3.
//   MATCH_VALUE_4 - Match value to be compared with the result of logically AND-ing (bit-wise) the Mask 4 value with
the received Match 4 byte.
//   MATCH_MASK_4 - Mask value to be logically AND-ed (bit-wise) with the Match 4 byte.
//   MATCH_CTRL_4 - Configuration of Match Byte 4.
*/
#define RF_MATCH_VALUE_1_12 \
...
*/
#define RF_FREQ_CONTROL_INTE_8 0x11, 0x40, 0x08, 0x00, 0x38, 0x0E, 0x61, 0x12, 0x00, 0x00, 0x20, 0xFE
...
#define RADIO_CONFIGURATION_DATA_ARRAY \
  { \
    0x07, RF_POWER_UP, 0x08, RF_GPIO_PIN_CFG, 0x06, RF_GLOBAL_XO_TUNE_2, 0x05, RF_GLOBAL_CONFIG_1, 0x06, \
        RF_INT_CTL_ENABLE_2, 0x08, RF_FRR_CTL_A_MODE_4, 0x0D, RF_PREAMBLE_TX_LENGTH_9, 0x0A, RF_SYNC_CONFIG_6, 0x10, \
        RF_PKT_CRC_CONFIG_12, 0x10, RF_PKT_RX_THRESHOLD_12, 0x10, RF_PKT_FIELD_3_CRC_CONFIG_12, 0x10, \
        RF_PKT_RX_FIELD_1_CRC_CONFIG_12, 0x09, RF_PKT_RX_FIELD_4_CRC_CONFIG_5, 0x08, RF_PKT_CRC_SEED_31_24_4, 0x10, \
        RF_MODEM_MOD_TYPE_12, 0x05, RF_MODEM_FREQ_DEV_0_1, 0x10, RF_MODEM_TX_RAMP_DELAY_12, 0x10, \
        RF_MODEM_BCR_NCO_OFFSET_2_12, 0x07, RF_MODEM_AFC_LIMITER_1_3, 0x05, RF_MODEM_AGC_CONTROL_1, 0x10, \
        RF_MODEM_AGC_WINDOW_SIZE_12, 0x0E, RF_MODEM_RAW_CONTROL_10, 0x06, RF_MODEM_RAW_SEARCH2_2, 0x06, \
        RF_MODEM_SPIKE_DET_2, 0x05, RF_MODEM_RSSI_MUTE_1, 0x09, RF_MODEM_DSA_CTRL1_5, 0x10, \
        RF_MODEM_CHFLT_RX1_CHFLT_COE13_7_0_12, 0x10, RF_MODEM_CHFLT_RX1_CHFLT_COE1_7_0_12, 0x10, \
        RF_MODEM_CHFLT_RX2_CHFLT_COE7_7_0_12, 0x08, RF_PA_MODE_4, 0x0B, RF_SYNTH_PFDCP_CPFF_7, 0x10, \
        RF_MATCH_VALUE_1_12, 0x0C, RF_FREQ_CONTROL_INTE_8, 0x00 \
  }
#else
#define RADIO_CONFIGURATION_DATA_ARRAY \
  { 0 }
